...
st.write(
""" #### Isn't that a slow process, let's compare the timeseries data between countries at once...
""")
...
if date != 'autoplay':
    ...
    fig = px.bar(conditioned_df, x='country', y='percentage_vaccinated', color='country')
...
# For all dates
    ...
    fig = px.bar(conditioned_df, x='country', y='percentage_vaccinated', range_y=[0, 100], color='country', animation_frame='date', animation_group='country')
